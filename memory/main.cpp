...
double absolute_difference3(double &a, double &b)
{
    return absolute_difference2(&a, &b);
}
...
void sum_and_absolute_difference2(double a, double b, double &sum, double &diff)
{
    sum_and_absolute_difference1(a, b, &sum, &diff);
}
...
// Your explanation: it should be passing by reference func not passing by value.
void swap3(double a, double b)
{
    double temp_a = a;
    a = b;
